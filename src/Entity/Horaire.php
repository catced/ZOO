...
#[ORM\UniqueConstraint(name: 'UNIQ_IDENTIFIER_Jour', fields: ['Jour'])]
class Horaire
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    private ?\DateTimeInterface $Matin_Deb = null; //interface
    ...
    public function setMatinDeb(?\DateTimeInterface $MatinDeb): self
    {
    ...
    public function setAmDeb(?\DateTimeInterface $AmDeb): self
    {
        $this->Am_Deb = $AmDeb;
    ...
    public function setAmFin(?\DateTimeInterface $AmFin): self
    {
        $this->Am_Fin = $AmFin;
